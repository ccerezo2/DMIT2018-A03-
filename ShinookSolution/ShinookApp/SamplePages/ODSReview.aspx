<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ODSReview.aspx.cs" Inherits="ShinookApp.SamplePages.WebForm1" %>
...
<%--    <asp:Label ID="Label1" runat="server" Text="Select an artist:"></asp:Label>&nbsp;&nbsp;
    ...
    <asp:Button ID="Fetch" runat="server" Text="Fetch" />
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1" AllowPaging="True" PageSize="10" Caption="Album List"
    ...
    <br />
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Album_FindByTitle" TypeName="ShinookSystem.BLL.AlbumController">
        <SelectParameters>
            <asp:ControlParameter ControlID="AlbumTitleArg" PropertyName="Text" DefaultValue="zxxdvc" Name="title" Type="String"></asp:ControlParameter>
        </SelectParameters>
    </asp:ObjectDataSource>
    <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Artist_List" TypeName="ShinookSystem.BLL.ArtistController"></asp:ObjectDataSource>
</asp:Content>
